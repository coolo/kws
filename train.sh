...
rm -rf /tmp/speech_commands_train/ /tmp/retrain_logs/; python train.py --data_bad=schlecht --data_good=gut --model_size_info 198 8 2 3 2 2 91 30 --dct_coefficient_count 36 --window_size_ms 20 --window_stride_ms 10 --learning_rate 0.00007 --how_many_training_steps 100000 --testing_percentage 0 --validation_percentage 10 --batch_size 20
