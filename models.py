...
def create_conv_model(fingerprint_4d, model_settings, is_training):
...
def create_low_latency_conv_model(fingerprint_4d, model_settings,
                                  is_training):
  ...
  if is_training:
    dropout_prob = tf.placeholder(tf.float32, name='dropout_prob')
  input_time_size = int(fingerprint_4d.shape[1])
  input_frequency_size = int(fingerprint_4d.shape[2])
  first_filter_width = 8
